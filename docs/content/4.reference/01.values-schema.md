...
description: JSON Schema validation for configuration
navigation:
  icon: i-lucide-file-json
---

The Heimdall Helm chart includes **values.schema.json** for configuration validation using JSON Schema Draft-07.
