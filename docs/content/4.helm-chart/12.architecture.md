...
└── (PostgreSQL now via Bitnami subchart)
```
...
- 📋 Database migration Helm hooks (planned)
- ✅ Removed standalone PostgreSQL templates

### Phase 3: Health & HA (✅ Complete)
...
- ❌ NetworkPolicy templates (planned)
- ❌ ServiceMonitor (Prometheus) (planned)
- ✅ Security contexts
...
- ✅ Chart documentation (Nuxt UI site)

### Phase 6: Testing (✅ Complete)

- ✅ Helm test templates
- ✅ Integration tests (chart-testing)
- ✅ Chart linting (strict mode)
- ✅ Values validation (JSON Schema)
- ✅ Unit tests (helm-unittest, 92 tests)

### Phase 7: Release Automation (🚧 In Progress)

- ❌ CHANGELOG.md automation
- ✅ README.md generation (helm-docs)
- ❌ Artifact Hub metadata
- ❌ GitHub release workflow (chart-releaser)
