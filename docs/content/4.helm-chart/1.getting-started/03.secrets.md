...
::card-group
  ::card{icon="i-lucide-database" title="Database Configuration" to="/helm-chart/getting-started/database"}
  Configure PostgreSQL connection and migrations
  ::
  ::card{icon="i-lucide-settings" title="Environment Variables" to="/helm-chart/configuration/environment-variables"}
