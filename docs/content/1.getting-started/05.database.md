...
- ✅ Database init container for readiness checking
- ✅ Persistent volume support via Bitnami subchart
- ✅ Health probe configurations
- ✅ Database password management (three approaches)

### Planned Enhancements

- 📋 Database migration Helm hooks (see [Database Migrations](./database-migrations))
- 📋 Backup/restore runbooks
- 📋 Automated backup scheduling with CronJobs
...
::card-group
  ...
  ::
  ::card{icon="i-lucide-code" title="Template Helpers" to="/helm-chart/reference/template-helpers"}
